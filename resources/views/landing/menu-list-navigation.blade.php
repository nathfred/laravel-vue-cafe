            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 push-lg-4">
                        ...
                        <h4 class="text-muted mb-0">We only provide high-quality products</h4>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="menu-item menu-list-item">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-sm-6 text-sm-right">
                                                    <span class="text-md mr-4"><span class="text-muted">Rp. </span>{{ $item->price }}</span>
        ...
        <footer id="footer" class="bg-dark dark">
            ...
            <div class="container">
                ...
                <div class="footer-second-row">
                    <span class="text-muted">Copyright nathfred 2022</span>
                </div>
            </div>
